...
/* mosse */
// Get the instructions PC from current CPU
unsigned long get_instruction_counter(void)
{
...
// Get cycle PC from current CPU
unsigned long get_cycle_counter(void)
{
   unsigned cycles;
				...
				struct task_struct *next)
{
   ...
   instr_count = get_instruction_counter();
